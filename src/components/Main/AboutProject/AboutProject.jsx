        ...
        <section className="about-project" id="about_project">
            ...
            <ul className="about-project__limits">
                <li className="about-project__limit about-project__limit_backend">
                    <p className="about-project__limit-backend-time">1 неделя</p>
                    <p className="about-project__limit-name">Back-end</p>
                </li>
                <li className="about-project__limit about-project__limit_frontend">
                    <p className="about-project__limit-frontend-time">4 недели</p>
                    <p className="about-project__limit-name">Front-end</p>
                </li>
            </ul>
        </section>
    );
